...
```
cd existing_repo
git remote add origin https://gitlab.com/software-architecture-zero-nine/online-shopping-application.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/software-architecture-zero-nine/online-shopping-application/-/settings/integrations)
