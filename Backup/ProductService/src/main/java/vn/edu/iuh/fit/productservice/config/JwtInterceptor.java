...
import vn.edu.iuh.fit.productservice.dto.UserPrincipal;
...
public class JwtInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        // Bỏ qua xác thực cho các request GET /api/v1/products và GET /api/v1/products/{id}
        ...
        if (user != null && user.getAuthorities() != null) {
            ...
            for (Object authority : user.getAuthorities()) {
                ...
                if ("ROLE_ADMIN".equals(role) || "ROLE_MANAGER".equals(role)) {
                    // Người dùng có vai trò ROLE_ADMIN hoặc ROLE_MANAGER, token hợp lệ
                    return true;
                }
            }
        }
